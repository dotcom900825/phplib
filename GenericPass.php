...
class GenericPass extends Pass
{
    ...
    */
    ...
    function writeAllFiles()
    {
        ...
        DebugLog::WriteLogWithFormat("in generic pass writeall files! what is the key password?:$pwd");
    ...
    function createPassWithUniqueSerialNr(&$error)
    {
        ...
        try {
            ...
            $statement->execute(array(
                ...
                $this->useremail));
            if ($statement->rowCount() != 1) {
                DebugLog::WriteLogWithFormat("!!!Fatal ERROR!!! in generic pass createPassWithUniqueSerialNr");
            } else {
